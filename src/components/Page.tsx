...
const PasswordGenerator = () => {
  ...
  const handleCopyPassword = () => {
    ...
    if (text) {
      ...
      setTimeout(() => setShowClipboard(true), 1000);
    }
  };
    ...
    <div className="container">
      {password && (
        <div className="password">
          <span ref={textRef}>{showMessage ? "*** COPIED! ***" : password}</span>
          {showClipboard && (
      ...
      <form onSubmit={handleSubmit}>
        <div className="input-field">
          ...
          />
          <label className="uppercase" htmlFor="useUppercase">
            Uppercase Letters
          </label>
        </div>
        <div className="input-field">
          <input
            ...
            onChange={handleCheckboxChange}
          />
          <label className="lowercase" htmlFor="useLowercase">
            Lowercase Letters
          </label>
        </div>
        <div className="input-field">
          <input
            ...
            onChange={handleCheckboxChange}
          />
          <label className="uppercase" htmlFor="useNumbers">
            num83r5
          </label>
        </div>
        <div className="input-field">
          <input
            ...
            onChange={handleCheckboxChange}
          />
          <label className="uppercase" htmlFor="useSpecial">
            $pe[!@l [h@r@[ter$
          </label>
        </div>
